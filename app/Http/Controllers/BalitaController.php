...
class BalitaController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user->posyandu_id !== null) {
            $balita = Balita::aktif()->with(['posyandu', 'orangtua.dusun', 'orangtua.rt'])->where('posyandu_id', $user->posyandu_id)->orderBy('name', 'asc')->get();
        } else {
            $balita = Balita::aktif()->with(['posyandu', 'orangtua.dusun', 'orangtua.rt'])->orderBy('name', 'asc')->get();
        }
