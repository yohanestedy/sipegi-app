@extends('layout.main', ['title' => 'Balita Lulus'])
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Balita Lulus</h3>
                    <p class="text-subtitle text-muted">adalah balita yang berumur lebih dari 5 tahun 30 hari.</p>
                </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($balitas as $balita)
                                    <tr>
                                        ...
                                        <td data-order="{{ $balita->tgl_nonaktif }}">
                                            {{ $balita->tgl_nonaktif_angka }}
                                        </td>
                                        <td>{{ $balita->name }}</td>
