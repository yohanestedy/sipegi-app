@extends('layout.main', ['title' => 'Balita Meninggal'])
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Balita Meninggal</h3>
                    <p class="text-subtitle text-muted">Adalah daftar balita yang meninggal di Desa Selorejo.
                    </p>
                </div>
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Formulir Balita Meninggal</h4>
                </div>
                <div class="card-body">

                    <form id="formPindahKeluar" method="POST" action="{{ route('balitanonaktif.store-meninggal') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-2 mb-3">
                                <button id="btn-pindahkan" type="submit" class="btn btn-danger w-100 swal-delete"
                                    disabled><i class="fa-solid fa-xmark-large"></i>
                                    Nonaktifkan</button>
                            </div>
                        </div>
                    </form>
