@extends('layout.main', ['title' => 'Balita BGM'])
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-header">
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item">
                <a href="{{ route('gizi-bermasalah.bgm') }}">Balita BGM</a>
            </li>
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-12 order-md-1 order-last">
                    <h3>Balita BGM (Bawah Garis Merah)</h3>
                    <p class="text-subtitle text-muted">Z-Score BB/U kurang dari -2 SD</p>
                </div>
