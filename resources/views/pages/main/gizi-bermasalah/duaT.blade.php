@extends('layout.main', ['title' => 'Balita 2T'])
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-header">
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item">
                <a href="{{ route('gizi-bermasalah.bgm') }}">Balita 2T</a>
            </li>
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-12 order-md-1 order-last">
                    <h3>Balita 2T</h3>
                    <p class="text-subtitle text-muted">Balita yang tidak naik berat badannya sebanyak 2 kali berturut turut
                    </p>
                </div>
        ...
        <section class="section">
            ...
            <div class="card">
                ...
                <div class="pb-1 card-header d-flex justify-content-between align-items-center">
                    ...
                    <h2>
                        <span class="badge bg-light-danger" id="jumlahDataPengukuran"></span>
                    </h2>
                </div>
                                    ...
                                    <form action="{{ route('balitaukur.delete', ['id' => $balitaUkur->id]) }}"
                                        ...
                                        <td style="text-align: center">
                                            <div style="font-weight: 600; {{ $balitaUkur->balita->gender_display == 'Perempuan' ? 'background-color: #fcd8ff; color:#855f82' : 'background-color: #d2eeff; color: #526483' }} "
                                                class="badge">
                                                {{ $balitaUkur->balita->gender_display }}
                                            </div>
                                        </td>

                                        <td data-order="{{ $balitaUkur->tgl_ukur }}" style="text-align: center">
                                            {{ $balitaUkur->tgl_ukur_display }}
                                        </td>
                                        ...
                                        <td style="text-align: center">
                                            {{ $balitaUkur->zscore_bb_tb ? $balitaUkur->zscore_bb_tb : '-' }}
                                        </td>
                                        ...
                                        <td style="text-align: center">
                                            {{ $balitaUkur->zscore_lk_u ? $balitaUkur->zscore_lk_u : '-' }}
                                        </td>
