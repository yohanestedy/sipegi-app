                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3 mb-4 medium-text">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link active" id="v-pills-BB/U-tab" data-bs-toggle="pill" href="#v-pills-BB/U"
                                    role="tab" aria-controls="v-pills-BB/U" aria-selected="true">Berat Badan / Umur</a>
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="v-pills-BB/U" role="tabpanel"
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="BB/U/L-tab" data-bs-toggle="tab" href="#BB/U/L"
                                                role="tab" aria-controls="BB/U/L" aria-selected="true">Laki-laki</a>
                                        </li>
                                ...
                                <div class="tab-pane fade" id="v-pills-BB/TB" role="tabpanel"
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="BB/PB/P-tab" data-bs-toggle="tab" href="#BB/PB/P"
                                                role="tab" aria-controls="BB/PB/P" aria-selected="false"
                                                tabindex="-1">Perempuan (0-24)</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="BB/TB/L-tab" data-bs-toggle="tab" href="#BB/TB/L"
                                                role="tab" aria-controls="BB/TB/L" aria-selected="false">Laki-laki
                                                (24-60)</a>
                                        </li>

                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="BB/TB/P-tab" data-bs-toggle="tab" href="#BB/TB/P"
                                                role="tab" aria-controls="BB/TB/P" aria-selected="false"
                                                tabindex="-1">Perempuan (24-60)</a>
                                        </li>
                                    </ul>
