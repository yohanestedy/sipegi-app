        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    ...
                    <p class="fs-5 text-gray-600">Maaf, saat ini website kami sedang mengalami gangguan. Silakan coba
                        lagi nanti atau hubungi pengembang jika Anda memerlukan bantuan.</p>
